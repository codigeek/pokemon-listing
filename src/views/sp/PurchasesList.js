...
import { getRecords, deleteRecord } from 'views/list/functions/general';
...
const PurchasesList = () => {
  ...
  const title = 'Compras';
  const description = 'Gestionar compra';
  const editURL = '/compra-detalle';
  const returnURL = '/compras/compras';
  const ApiURL = 'purchase';
