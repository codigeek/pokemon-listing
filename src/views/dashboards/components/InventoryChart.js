...
const InventoryChart = () => {
  ...
  const data = React.useMemo(() => {
    return {
      labels: ['PROD#1', 'PROD#2', 'PROD#3', 'PROD#4', 'PROD#5', 'PROD#6', 'PROD#7'],
      datasets: [
        {
          label: 'Bodega 1',
...
export default React.memo(InventoryChart);
