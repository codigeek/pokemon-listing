...
const StatusSPList = () => {
  ...
  const title = 'Estatus';
  const description = 'Gestionar estatus';
  const editURL = '/estatus-detalle';
  const returnURL = '/administracion/estatus_sp';
  const ApiURL = 'status_sp';
